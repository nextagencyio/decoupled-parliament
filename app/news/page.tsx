...
export const metadata: Metadata = {
  title: 'News | National Parliament of Aldoria',
  description: 'Latest parliamentary news, press releases, committee reports, and Speaker announcements from the National Parliament of Aldoria.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-slate-300">
              Parliamentary news, press releases, committee reports, and official announcements.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {items.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">News will appear here once content is imported.</p>
            </div>
          ) : (
