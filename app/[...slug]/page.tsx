  ...
  return (
    <div className="text-center py-16">
      <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-12">
        <h1 className="text-2xl font-semibold text-primary-900 mb-4">Page Not Found</h1>
          ...
          <ErrorBoundary>
            <article className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
              ...
              <div className="p-6 md:p-8">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-900 mb-4 md:mb-6 font-display">{title}</h1>
                <div className="prose prose-sm sm:prose lg:prose-lg max-w-none prose-headings:text-primary-900 prose-a:text-accent-600" dangerouslySetInnerHTML={{ __html: bodyHtml }} />
              </div>
            </article>
          </ErrorBoundary>
        </main>
